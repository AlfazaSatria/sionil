            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        <tr><td width="270">Kode Matakuliah</td><td>{{ $jadwal->kode_mp}}</td></tr>
                        <tr><td>Nama Matakuliah</td><td>{{ $jadwal->nama_mp}}</td></tr>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <?php for($pertemuan=1;$pertemuan<=16;$pertemuan++)
                            {
                                echo "<td>".chek_kehadiran($row->nisn,Request::segment(2),$pertemuan)."</td>";
                            }
                            ?>
                        </tr>
                        @endforeach
...
<script>
    ...
    function simpan_nilai(id_raport)
    {
        var nilai_uas = $("#uas-"+id_raport).val();
        var nilai_uts = $("#uts-"+id_raport).val();
        var nilai_tugas = $("#tugas-"+id_raport).val();
        var nilai_kehadiran = $("#kehadiran-"+id_raport).val();
