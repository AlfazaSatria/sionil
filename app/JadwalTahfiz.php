...
class JadwalTahfiz extends Model
{
    use SoftDeletes;
    protected $fillable = ['hari_id', 'kelas_id', 'mapel_id', 'jam_mulai', 'jam_selesai', 'ruang_id','tahfiz_id'];
    ...
    {
      return $this->belongsTo('App\Tahfiz')->withDefault();
    }
